...
variable "vpc_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "DemoVPC", "created-by" = "terraform_automation" }
}
...
variable "asg_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "demo-asg-sg", "created-by" = "terraform_automation" }
}
...
variable "asg_iam_role_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "demo-asg-iam-role", "created-by" = "terraform_automation" }
}
...
variable "asg_instance_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "demo-asg-instance", "created-by" = "terraform_automation" }
}

variable "asg_volume_tags" {
  description = "Auto scaling group volume tags"
  type        = map(string)
  default     = { "Name" = "demo-asg-volume", "created-by" = "terraform_automation" }
}

variable "asg_tags" {
  description = "Auto scaling group tags"
  type        = map(string)
  default     = { "Name" = "demo-asg", "created-by" = "terraform_automation" }
}
...
variable "alb_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "demo-alb-sg", "created-by" = "terraform_automation" }
}
...
variable "alb_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "demo-alb", "created-by" = "terraform_automation" }
}
...
variable "rds_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "demo-rds-sg", "created-by" = "terraform_automation" }
}
...
variable "rds_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "demo-rds", "created-by" = "terraform_automation" }
}
